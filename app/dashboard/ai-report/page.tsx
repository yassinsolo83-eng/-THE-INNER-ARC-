...
export const metadata = { title: 'AI Reading — The Inner Arc' }
    ...
    <SiteShell>
      <main className="mx-auto max-w-2xl px-6 py-20 lg:py-28">
        <HeroEntrance>
          ...
          <p className="mt-8 text-xs uppercase tracking-[0.3em] text-accent">Instant insight</p>
          <h1 className="mt-4 font-serif text-5xl text-foreground">AI Reading</h1>
          <p className="mt-4 text-muted-foreground">
            Get an instant, personalized astrological report generated by AI based on your
            birth details. Reports are delivered in English and Arabic.
          </p>
        </HeroEntrance>
          ...
          {!hasBirth ? (
            <div className="border border-border bg-card p-8 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                You need to add your birth date, time, and location before generating a report.
              </p>
              <Link
            ...
            <AiReportGenerator coinBalance={coinBalance} />
          )}
        </div>
      </main>
    </SiteShell>
