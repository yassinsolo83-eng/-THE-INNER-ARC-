    ...
    <SiteShell>
      <main>
        ...
        <section
          ...
          style={{ backgroundImage: 'url(/images/about-tarot-sun-card.jpg)' }}
        >
          ...
          <div className="relative mx-auto w-full max-w-7xl px-6 pb-16 lg:px-10">
            ...
            <HeroEntrance><p className="text-xs uppercase tracking-[0.3em] text-accent">An introduction</p></HeroEntrance>
            <HeroEntrance delay={150}><h1 className="mt-4 max-w-3xl font-serif text-5xl leading-none text-foreground md:text-7xl">The cards are not the answer. They are an invitation.</h1></HeroEntrance>
            <HeroEntrance delay={300}><p className="mt-6 max-w-xl text-lg leading-8 text-muted-foreground">Tarot is a visual language for paying attention — to your instincts, your patterns, and the possibility just beyond the obvious.</p></HeroEntrance>
          </div>
        </section>

        {/* ── Content ───────────────────────────────────── */}
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
          <div className="grid gap-16 lg:grid-cols-[1fr_0.35fr]">
