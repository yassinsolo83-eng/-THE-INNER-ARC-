...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: post ? `${post.title} — The Inner Arc` : 'Journal — The Inner Arc', description: post?.excerpt }
}
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <Reveal animation="scale" delay={400}>
            <div className="relative mt-12 aspect-[16/9] w-full overflow-hidden rounded-sm">
              <Image src={post.cover} alt={post.title} fill className="object-cover" sizes="(max-width: 768px) 100vw, 768px" priority />
            </div>
          </Reveal>
          ...
          <Reveal animation="fade-up" delay={200}>
            <div className="mt-20 max-w-2xl space-y-8 text-base leading-8 text-muted-foreground">
              ...
              <p>Tarot can be a way of making that quiet intentional. The images give our thoughts somewhere to land, and the act of looking asks us to stay with what we might otherwise hurry past.</p>
              <h2 className="pt-8 font-serif text-3xl text-foreground">A practice of noticing</h2>
              <p>The point is not to hand our decisions over to a deck of cards. It is to meet our own material with a little more tenderness, curiosity, and room to move. A good question can change the shape of a day.</p>
              <p>When you return to the cards, return to yourself. Let the symbol be a doorway rather than a verdict. The meaning is not fixed until you have had the chance to make it yours.</p>
              <div className="border-t border-border pt-8">
                <ArrowLink href="/blog">Back to the journal</ArrowLink>
              </div>
            </div>
          </Reveal>
        </div>
