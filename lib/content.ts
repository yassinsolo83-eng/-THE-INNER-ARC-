...
export const posts = [
  { slug: 'tarot-as-a-language-of-attention', title: 'Tarot as a language of attention', excerpt: 'What changes when we treat the cards less like a forecast and more like a conversation?', date: 'May 14, 2026', read: '6 min read', cover: '/images/about-tarot-sun-card.jpg' },
